  ...
  return (
    <Menu as="div" className="flex items-center justify-center relative">
      <div className="flex items-center justify-center">
        ...
        >
          <Menu.Items className="absolute right-0 mt-[3.5rem] w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none">
                  ...
                  {({ active }) => (
                    <Link href={s.link}>
                      <button
                        ...
                        } group flex w-full items-center rounded-md px-4 py-2 text-xl`}
                      >
                        {s.icon}
                        {s.name}
                      </button>
